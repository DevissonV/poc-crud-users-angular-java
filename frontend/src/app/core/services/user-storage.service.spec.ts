...
describe('UserStorageService', () => {
  ...
  describe('save - Error Handling', () => {
    it('should throw error when localStorage.setItem fails', () => {
      ...
      // Simular error en setItem (ej: cuota excedida)
      jest.spyOn(localStorage, 'setItem').mockImplementation(() => {
        throw new Error('QuotaExceededError');
      });

      expect(() => service.save(mockUser)).toThrow('No se pudo guardar el usuario');
    });
  });
  ...
  describe('update - Error Handling', () => {
    ...
    it('should throw error when localStorage.setItem fails during update', () => {
      // Simular error en setItem
      jest.spyOn(localStorage, 'setItem').mockImplementation(() => {
        throw new Error('QuotaExceededError');
      });

      expect(() => service.update('1', { nombre: 'Juan Carlos' }))
        .toThrow('No se pudo actualizar el usuario');
    });
  });
  ...
  describe('delete - Error Handling', () => {
    ...
    it('should throw error when localStorage.setItem fails during delete', () => {
      // Simular error en setItem
      jest.spyOn(localStorage, 'setItem').mockImplementation(() => {
